...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { design_name: @design.design_name, sales: @design.sales } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { design_name: @design.design_name, sales: @design.sales } }
