...
class TransactionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_item" do
    assert_difference('TransactionItem.count') do
      post transaction_items_url, params: { transaction_item: { price: @transaction_item.price, product_id: @transaction_item.product_id, quantity: @transaction_item.quantity, transaction_order_id: @transaction_item.transaction_order_id, user_id: @transaction_item.user_id } }
    end
  ...
  test "should update transaction_item" do
    patch transaction_item_url(@transaction_item), params: { transaction_item: { price: @transaction_item.price, product_id: @transaction_item.product_id, quantity: @transaction_item.quantity, transaction_order_id: @transaction_item.transaction_order_id, user_id: @transaction_item.user_id } }
